        ...
        >
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-7 xl:grid-cols-8 gap-3 md:gap-6">
            {skills.map((skill, skillIndex) => (
              ...
              >
                <div className="glass-animated rounded-2xl p-3 md:p-4 shadow-lg hover:shadow-xl transition-all duration-200 flex flex-col items-center">
                  {/* Skill Icon */}
                ...
                {hoveredSkill === skill.name && (
                  <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 bg-white dark:bg-slate-800 text-gray-900 dark:text-white text-xs px-3 py-1 rounded-lg whitespace-nowrap z-20 shadow-lg glass">
