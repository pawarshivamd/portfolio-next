          ...
          >
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    <a
                      href="mailto:shivampawar1107@gmail.com"
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                <a
                  href="https://www.linkedin.com/in/shivam-pawar7/"
                  onClick={playClickWithVibration}
                  aria-label="linkedin"
                  className="w-10 h-10 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <a
                  href="https://github.com/pawarshivamd"
                  onClick={playClickWithVibration}
                  aria-label="github"
                  className="w-10 h-10 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <a
                  href="https://dev.to/pawar-shivam7"
                  onClick={playClickWithVibration}
